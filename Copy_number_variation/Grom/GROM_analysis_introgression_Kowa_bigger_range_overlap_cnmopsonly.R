...
BKar2<-data.frame(matrix(NA,ncol=5,nrow=nrow(as.data.frame(subsetByOverlaps(Buko_arenosa_cnvs_HC_strict_GRange,BKar)))),as.data.frame(subsetByOverlaps(Buko_arenosa_cnvs_HC_strict_GRange,BKar))[,c(6,7:40)],matrix(NA,ncol=14,nrow=nrow(as.data.frame(subsetByOverlaps(Buko_arenosa_cnvs_HC_strict_GRange,BKar)))))
colnames(BKar2)<-names(Buko_arenosa_CNVs_overlapping_strict)
BKar2$Scaffold<-BKar2$Copy_scaffold

Buko_arenosa_CNVs_HC_GROM_strict<-rbind(Buko_arenosa_CNVs_overlapping_strict,BKar2)

CNVs_Buko_arenosa_HC_GROM_cov<-Buko_arenosa_CNVs_HC_GROM_strict
excl<-which(((CNVs_Buko_arenosa_HC_GROM_cov$CN_class=="CN0"|CNVs_Buko_arenosa_HC_GROM_cov$CN_class=="CN1"|CNVs_Buko_arenosa_HC_GROM_cov$CN_class=="CN2"|CNVs_Buko_arenosa_HC_GROM_cov$CN_class=="CN3")&CNVs_Buko_arenosa_HC_GROM_cov$GROM_ALT=="<DUP>"))
excl<-c(excl,which((CNVs_Buko_arenosa_HC_GROM_cov$GROM_ALT=="<DEL>"&!(CNVs_Buko_arenosa_HC_GROM_cov$CN_class=="CN0"|CNVs_Buko_arenosa_HC_GROM_cov$CN_class=="CN1"|CNVs_Buko_arenosa_HC_GROM_cov$CN_class=="CN2"|CNVs_Buko_arenosa_HC_GROM_cov$CN_class=="CN3"))))

CNVs_Buko_arenosa_HC_GROM_cov<-CNVs_Buko_arenosa_HC_GROM_cov[-excl,]

write.table(CNVs_Buko_arenosa_HC_GROM_cov,"Buko_Kowa_arenosa_CNVs_overlap_strict_cnmopsonly.table",row.names=F,sep="\t")
require(openxlsx)
write.xlsx(CNVs_Buko_arenosa_HC_GROM_cov,"CNVs_overlap_strict_BukoKowa_arenosa_cnmopsonly.xlsx",sheetName="Buko_Kowa_arenosa",row.names=F,overwrite=T)
...
CNVs_Buko_arenosa_HC_GROM_cov_GRange<-GRanges(seqnames=tolower(CNVs_Buko_arenosa_HC_GROM_cov$Scaffold),ranges=IRanges(start=ifelse(CNVs_Buko_arenosa_HC_GROM_cov$Copy_start<CNVs_Buko_arenosa_HC_GROM_cov$GROM_Start_pos|is.na(CNVs_Buko_arenosa_HC_GROM_cov$GROM_Start_pos),CNVs_Buko_arenosa_HC_GROM_cov$Copy_start,
CNVs_Buko_arenosa_HC_GROM_cov$GROM_Start_pos),end=ifelse(CNVs_Buko_arenosa_HC_GROM_cov$Copy_end>CNVs_Buko_arenosa_HC_GROM_cov$GROM_End_pos|is.na(CNVs_Buko_arenosa_HC_GROM_cov$GROM_End_pos),CNVs_Buko_arenosa_HC_GROM_cov$Copy_end,CNVs_Buko_arenosa_HC_GROM_cov$GROM_End_pos)))
...
BKar3<-data.frame(matrix(NA,ncol=5,nrow=nrow(as.data.frame(subsetByOverlaps(Buko_arenosa_cnvs_HC_strict_GRange,BZ_ar_Lumpy_GRange)))),as.data.frame(subsetByOverlaps(Buko_arenosa_cnvs_HC_strict_GRange,BZ_ar_Lumpy_GRange))[,c(6,7:40)],matrix(NA,ncol=48,nrow=nrow(as.data.frame(subsetByOverlaps(Buko_arenosa_cnvs_HC_strict_GRange,BZ_ar_Lumpy_GRange)))))
colnames(BKar3)<-names(Buko_arenosa_overlap_strict_df2)
BKar3$Scaffold<-BKar3$Copy_scaffold

Buko_arenosa_overlap_strict_dfb<-rbind(Buko_arenosa_overlap_strict_df2,BKar3)

write.xlsx(Buko_arenosa_overlap_strict_dfb,"CNVs_overlap_strict_BukoKowa_arenosa_Lumpy_cnmopsonly.xlsx",sheetName="Buko_Kowa_arenosa",row.names=F,overwrite=T)
...
write.xlsx(Buko_halleri_overlap_strict,"CNVs_overlap_strict_BukoKowa_halleri_Lumpy.xlsx",sheetName="Buko_Kowa_halleri",row.names=F)
...
MKar2<-data.frame(matrix(NA,ncol=5,nrow=nrow(as.data.frame(subsetByOverlaps(Mias_arenosa_cnvs_HC_strict_GRange,MKar)))),as.data.frame(subsetByOverlaps(Mias_arenosa_cnvs_HC_strict_GRange,MKar))[,c(6,7:40)],matrix(NA,ncol=14,nrow=nrow(as.data.frame(subsetByOverlaps(Mias_arenosa_cnvs_HC_strict_GRange,MKar)))))
colnames(MKar2)<-names(Mias_arenosa_CNVs_overlapping_strict)
MKar2$Scaffold<-MKar2$Copy_scaffold


Mias_arenosa_CNVs_HC_GROM_strict<-rbind(Mias_arenosa_CNVs_overlapping_strict,MKar2)

CNVs_Mias_arenosa_HC_GROM_cov<-Mias_arenosa_CNVs_HC_GROM_strict
excl<-which(((CNVs_Mias_arenosa_HC_GROM_cov$CN_class=="CN0"|CNVs_Mias_arenosa_HC_GROM_cov$CN_class=="CN1"|CNVs_Mias_arenosa_HC_GROM_cov$CN_class=="CN2"|CNVs_Mias_arenosa_HC_GROM_cov$CN_class=="CN3")&CNVs_Mias_arenosa_HC_GROM_cov$GROM_ALT=="<DUP>"))
excl<-c(excl,which((CNVs_Mias_arenosa_HC_GROM_cov$GROM_ALT=="<DEL>"&!(CNVs_Mias_arenosa_HC_GROM_cov$CN_class=="CN0"|CNVs_Mias_arenosa_HC_GROM_cov$CN_class=="CN1"|CNVs_Mias_arenosa_HC_GROM_cov$CN_class=="CN2"|CNVs_Mias_arenosa_HC_GROM_cov$CN_class=="CN3"))))

CNVs_Mias_arenosa_HC_GROM_cov<-CNVs_Mias_arenosa_HC_GROM_cov[-excl,]

write.table(CNVs_Mias_arenosa_HC_GROM_cov,"Mias_Kowa_arenosa_CNVs_overlap_strict_cnmopsonly.table",row.names=F,sep="\t")
write.xlsx(CNVs_Mias_arenosa_HC_GROM_cov,"CNVs_overlap_strict_MiasKowa_arenosa_cnmopsonly.xlsx",sheetName="Mias_Kowa_arenosa",row.names=F,overwrite=T)
...
CNVs_Mias_arenosa_HC_GROM_cov_GRange<-GRanges(seqnames=tolower(CNVs_Mias_arenosa_HC_GROM_cov$Scaffold),ranges=IRanges(start=ifelse(CNVs_Mias_arenosa_HC_GROM_cov$Copy_start<CNVs_Mias_arenosa_HC_GROM_cov$GROM_Start_pos|is.na(CNVs_Mias_arenosa_HC_GROM_cov$GROM_Start_pos),CNVs_Mias_arenosa_HC_GROM_cov$Copy_start,
CNVs_Mias_arenosa_HC_GROM_cov$GROM_Start_pos),end=ifelse(CNVs_Mias_arenosa_HC_GROM_cov$Copy_end>CNVs_Mias_arenosa_HC_GROM_cov$GROM_End_pos|is.na(CNVs_Mias_arenosa_HC_GROM_cov$GROM_End_pos),CNVs_Mias_arenosa_HC_GROM_cov$Copy_end,CNVs_Mias_arenosa_HC_GROM_cov$GROM_End_pos)))
...
MKar3<-data.frame(matrix(NA,ncol=5,nrow=nrow(as.data.frame(subsetByOverlaps(Mias_arenosa_cnvs_HC_strict_GRange,MK_ar_Lumpy_GRange)))),as.data.frame(subsetByOverlaps(Mias_arenosa_cnvs_HC_strict_GRange,MK_ar_Lumpy_GRange))[,c(6,7:40)],matrix(NA,ncol=ncol(Mias_arenosa_overlap_strict_df2)-40,nrow=nrow(as.data.frame(subsetByOverlaps(Mias_arenosa_cnvs_HC_strict_GRange,MK_ar_Lumpy_GRange)))))
colnames(MKar3)<-names(Mias_arenosa_overlap_strict_df2)
MKar3$Scaffold<-MKar3$Copy_scaffold

Mias_arenosa_overlap_strict_dfb<-rbind(Mias_arenosa_overlap_strict_df2,MKar3)

write.xlsx(Mias_arenosa_overlap_strict_dfb,"CNVs_overlap_strict_MiasKowa_arenosa_Lumpy_cnmopsonly.xlsx",sheetName="Mias_Kowa_arenosa",row.names=F,overwrite=T)
...
Mias_halleri_CNVs_HC_GROM_strict<-Mias_halleri_CNVs_overlapping_strict
...
PKar2<-data.frame(matrix(NA,ncol=5,nrow=nrow(as.data.frame(subsetByOverlaps(Piek_arenosa_cnvs_HC_strict_GRange,PKar)))),as.data.frame(subsetByOverlaps(Piek_arenosa_cnvs_HC_strict_GRange,PKar))[,c(6,7:40)],matrix(NA,ncol=14,nrow=nrow(as.data.frame(subsetByOverlaps(Piek_arenosa_cnvs_HC_strict_GRange,PKar)))))
colnames(PKar2)<-names(Piek_arenosa_CNVs_overlapping_strict)
PKar2$Scaffold<-PKar2$Copy_scaffold


Piek_arenosa_CNVs_HC_GROM_strict<-rbind(Piek_arenosa_CNVs_overlapping_strict,PKar2)

CNVs_Piek_arenosa_HC_GROM_cov<-Piek_arenosa_CNVs_HC_GROM_strict
excl<-which(((CNVs_Piek_arenosa_HC_GROM_cov$CN_class=="CN0"|CNVs_Piek_arenosa_HC_GROM_cov$CN_class=="CN1"|CNVs_Piek_arenosa_HC_GROM_cov$CN_class=="CN2"|CNVs_Piek_arenosa_HC_GROM_cov$CN_class=="CN3")&CNVs_Piek_arenosa_HC_GROM_cov$GROM_ALT=="<DUP>"))
excl<-c(excl,which((CNVs_Piek_arenosa_HC_GROM_cov$GROM_ALT=="<DEL>"&!(CNVs_Piek_arenosa_HC_GROM_cov$CN_class=="CN0"|CNVs_Piek_arenosa_HC_GROM_cov$CN_class=="CN1"|CNVs_Piek_arenosa_HC_GROM_cov$CN_class=="CN2"|CNVs_Piek_arenosa_HC_GROM_cov$CN_class=="CN3"))))

CNVs_Piek_arenosa_HC_GROM_cov<-CNVs_Piek_arenosa_HC_GROM_cov[-excl,]
...
CNVs_Piek_arenosa_HC_GROM_cov_GRange<-GRanges(seqnames=tolower(CNVs_Piek_arenosa_HC_GROM_cov$Scaffold),ranges=IRanges(start=ifelse(CNVs_Piek_arenosa_HC_GROM_cov$Copy_start<CNVs_Piek_arenosa_HC_GROM_cov$GROM_Start_pos|is.na(CNVs_Piek_arenosa_HC_GROM_cov$GROM_Start_pos),CNVs_Piek_arenosa_HC_GROM_cov$Copy_start,
CNVs_Piek_arenosa_HC_GROM_cov$GROM_Start_pos),end=ifelse(CNVs_Piek_arenosa_HC_GROM_cov$Copy_end>CNVs_Piek_arenosa_HC_GROM_cov$GROM_End_pos|is.na(CNVs_Piek_arenosa_HC_GROM_cov$GROM_End_pos),CNVs_Piek_arenosa_HC_GROM_cov$Copy_end,CNVs_Piek_arenosa_HC_GROM_cov$GROM_End_pos)))
...
PKar3<-data.frame(matrix(NA,ncol=5,nrow=nrow(as.data.frame(subsetByOverlaps(Piek_arenosa_cnvs_HC_strict_GRange,PK_ar_Lumpy_GRange)))),as.data.frame(subsetByOverlaps(Piek_arenosa_cnvs_HC_strict_GRange,PK_ar_Lumpy_GRange))[,c(6,7:40)],matrix(NA,ncol=ncol(Piek_arenosa_overlap_strict_df2)-40,nrow=nrow(as.data.frame(subsetByOverlaps(Piek_arenosa_cnvs_HC_strict_GRange,PK_ar_Lumpy_GRange)))))
colnames(PKar3)<-names(Piek_arenosa_overlap_strict_df2)
PKar3$Scaffold<-PKar3$Copy_scaffold

Piek_arenosa_overlap_strict_dfb<-rbind(Piek_arenosa_overlap_strict_df2,PKar3)

write.xlsx(Piek_arenosa_overlap_strict_dfb,"CNVs_overlap_strict_PiekKowa_arenosa_Lumpy_cnmopsonly.xlsx",sheetName="Piek_Kowa_arenosa",row.names=F,overwrite=T)
...
Piek_halleri_CNVs_HC_GROM_strict<-Piek_halleri_CNVs_overlapping_strict
...
KaKoar2<-data.frame(matrix(NA,ncol=5,nrow=nrow(as.data.frame(subsetByOverlaps(Kato_arenosa_cnvs_HC_strict_GRange,KaKoar)))),as.data.frame(subsetByOverlaps(Kato_arenosa_cnvs_HC_strict_GRange,KaKoar))[,c(6,7:40)],matrix(NA,ncol=14,nrow=nrow(as.data.frame(subsetByOverlaps(Kato_arenosa_cnvs_HC_strict_GRange,KaKoar)))))
colnames(KaKoar2)<-names(Kato_arenosa_CNVs_overlapping_strict)
KaKoar2$Scaffold<-KaKoar2$Copy_scaffold


Kato_arenosa_CNVs_HC_GROM_strict<-rbind(Kato_arenosa_CNVs_overlapping_strict,KaKoar2)

CNVs_Kato_arenosa_HC_GROM_cov<-Kato_arenosa_CNVs_HC_GROM_strict
excl<-which(((CNVs_Kato_arenosa_HC_GROM_cov$CN_class=="CN0"|CNVs_Kato_arenosa_HC_GROM_cov$CN_class=="CN1"|CNVs_Kato_arenosa_HC_GROM_cov$CN_class=="CN2"|CNVs_Kato_arenosa_HC_GROM_cov$CN_class=="CN3")&CNVs_Kato_arenosa_HC_GROM_cov$GROM_ALT=="<DUP>"))
excl<-c(excl,which((CNVs_Kato_arenosa_HC_GROM_cov$GROM_ALT=="<DEL>"&!(CNVs_Kato_arenosa_HC_GROM_cov$CN_class=="CN0"|CNVs_Kato_arenosa_HC_GROM_cov$CN_class=="CN1"|CNVs_Kato_arenosa_HC_GROM_cov$CN_class=="CN2"|CNVs_Kato_arenosa_HC_GROM_cov$CN_class=="CN3"))))

CNVs_Kato_arenosa_HC_GROM_cov<-CNVs_Kato_arenosa_HC_GROM_cov[-excl,]
...
CNVs_Kato_arenosa_HC_GROM_cov_GRange<-GRanges(seqnames=tolower(CNVs_Kato_arenosa_HC_GROM_cov$Scaffold),ranges=IRanges(start=ifelse(CNVs_Kato_arenosa_HC_GROM_cov$Copy_start<CNVs_Kato_arenosa_HC_GROM_cov$GROM_Start_pos|is.na(CNVs_Kato_arenosa_HC_GROM_cov$GROM_Start_pos),CNVs_Kato_arenosa_HC_GROM_cov$Copy_start,
CNVs_Kato_arenosa_HC_GROM_cov$GROM_Start_pos),end=ifelse(CNVs_Kato_arenosa_HC_GROM_cov$Copy_end>CNVs_Kato_arenosa_HC_GROM_cov$GROM_End_pos|is.na(CNVs_Kato_arenosa_HC_GROM_cov$GROM_End_pos),CNVs_Kato_arenosa_HC_GROM_cov$Copy_end,CNVs_Kato_arenosa_HC_GROM_cov$GROM_End_pos)))
...
KaKoar3<-data.frame(matrix(NA,ncol=5,nrow=nrow(as.data.frame(subsetByOverlaps(Kato_arenosa_cnvs_HC_strict_GRange,KaKo_ar_Lumpy_GRange)))),as.data.frame(subsetByOverlaps(Kato_arenosa_cnvs_HC_strict_GRange,KaKo_ar_Lumpy_GRange))[,c(6,7:40)],matrix(NA,ncol=ncol(Kato_arenosa_overlap_strict_df2)-40,nrow=nrow(as.data.frame(subsetByOverlaps(Kato_arenosa_cnvs_HC_strict_GRange,KaKo_ar_Lumpy_GRange)))))
colnames(KaKoar3)<-names(Kato_arenosa_overlap_strict_df2)
KaKoar3$Scaffold<-KaKoar3$Copy_scaffold

Kato_arenosa_overlap_strict_dfb<-rbind(Kato_arenosa_overlap_strict_df2,KaKoar3)

write.xlsx(Kato_arenosa_overlap_strict_dfb,"CNVs_overlap_strict_KatoKowa_arenosa_Lumpy_cnmopsonly.xlsx",sheetName="Kato_Kowa_arenosa",row.names=F,overwrite=T)
...
Kato_arenosa_overlap_strict_df3<-Kato_arenosa_overlap_strict_dfb[,-c(19:40)]
Kato_arenosa_overlap_strict_df4<-merge(Desc_HM,Kato_arenosa_overlap_strict_df3,by.x="Alyr_ID",by.y="Lyr_Gene",all.y=T)

Buko_arenosa_overlap_strict_df3<-Buko_arenosa_overlap_strict_dfb[,-c(19:40)]
Buko_arenosa_overlap_strict_df4<-merge(Desc_HM,Buko_arenosa_overlap_strict_df3,by.x="Alyr_ID",by.y="Lyr_Gene",all.y=T)

Mias_arenosa_overlap_strict_df3<-Mias_arenosa_overlap_strict_dfb[,-c(19:40)]
Mias_arenosa_overlap_strict_df4<-merge(Desc_HM,Mias_arenosa_overlap_strict_df3,by.x="Alyr_ID",by.y="Lyr_Gene",all.y=T)

Piek_arenosa_overlap_strict_df3<-Piek_arenosa_overlap_strict_dfb[,-c(19:40)]
Piek_arenosa_overlap_strict_df4<-merge(Desc_HM,Piek_arenosa_overlap_strict_df3,by.x="Alyr_ID",by.y="Lyr_Gene",all.y=T)

write.xlsx(Kato_arenosa_overlap_strict_df4,"CNVs_overlap_strict_KatoKowa_arenosa_Lumpy_newortho_cnmopsonly.xlsx",sheetName="Kato_Kowa_arenosa",row.names=F,overwrite=T)
write.xlsx(Buko_arenosa_overlap_strict_df4,"CNVs_overlap_strict_BukoKowa_arenosa_Lumpy_newortho_cnmopsonly.xlsx",sheetName="Buko_Kowa_arenosa",row.names=F,overwrite=T)
write.xlsx(Mias_arenosa_overlap_strict_df4,"CNVs_overlap_strict_MiasKowa_arenosa_Lumpy_newortho_cnmopsonly.xlsx",sheetName="Mias_Kowa_arenosa",row.names=F,overwrite=T)
write.xlsx(Piek_arenosa_overlap_strict_df4,"CNVs_overlap_strict_PiekKowa_arenosa_Lumpy_newortho_cnmopsonly.xlsx",sheetName="Piek_Kowa_arenosa",row.names=F,overwrite=T)


write.xlsx(Kato_arenosa_overlap_strict_df4[!duplicated(Kato_arenosa_overlap_strict_df4$Alyr_ID),],"CNVs_overlap_strict_KatoKowa_arenosa_Lumpy_dedup_newortho_cnmopsonly.xlsx",sheetName="Kato_Kowa_arenosa",row.names=F,overwrite=T)
write.xlsx(Buko_arenosa_overlap_strict_df4[!duplicated(Buko_arenosa_overlap_strict_df4$Alyr_ID),],"CNVs_overlap_strict_BukoKowa_arenosa_Lumpy_dedup_newortho_cnmopsonly.xlsx",sheetName="Buko_Kowa_arenosa",row.names=F,overwrite=T)
write.xlsx(Mias_arenosa_overlap_strict_df4[!duplicated(Mias_arenosa_overlap_strict_df4$Alyr_ID),],"CNVs_overlap_strict_MiasKowa_arenosa_Lumpy_dedup_newortho_cnmopsonly.xlsx",sheetName="Mias_Kowa_arenosa",row.names=F,overwrite=T)
write.xlsx(Piek_arenosa_overlap_strict_df4[!duplicated(Piek_arenosa_overlap_strict_df4$Alyr_ID),],"CNVs_overlap_strict_PiekKowa_arenosa_Lumpy_dedup_newortho_cnmopsonly.xlsx",sheetName="Piek_Kowa_arenosa",row.names=F,overwrite=T)
