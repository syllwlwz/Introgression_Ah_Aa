...
PZha <- referencecn.mops(cases=Piekhalleri,controls=Zapahalleri, minWidth = 4, minReadCount=6)
resCNMOPSPZha <- calcIntegerCopyNumbers(PZha)

ZPha <- referencecn.mops(cases=Zapahalleri,controls=Piekhalleri, minWidth = 4, minReadCount=6)
...
require(openxlsx)
write.xlsx(frequ3PZha,"CnvregionswithmeanhalleriPiekZapahalleri_minRead6_WL350_minL4_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigPZha<-read.xlsx("CnvregionswithmeanhalleriPiekZapahalleri_minRead6_WL350_minL4_min5samples.xlsx",1)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigPZha_lyrGenes_df_desc_w_orthogroup_highsupport,"GeneshalleriPiekZapahallericnvregions_minRead6_WL350_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GeneshalleriWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3ZPha,"CnvregionswithmeanhalleriZapaPiekhalleri_minRead6_WL350_minL4_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigZPha<-read.xlsx("CnvregionswithmeanhalleriZapaPiekhalleri_minRead6_WL350_minL4_min5samples.xlsx",1)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZPha_lyrGenes_df_desc_w_orthogroup_highsupport,"GeneshalleriZapaPiekhallericnvregions_minRead6_WL350_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GeneshalleriWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(PZhaonly,"PZha_cnvs_only_strict_minL4_WL350.table",row.names=F,sep="\t")
write.table(ZPhaonly,"ZPha_cnvs_only_strict_minL4_WL350.table",row.names=F,sep="\t")
