...
PKar <- referencecn.mops(cases=Piekarenosa,controls=Kowaarenosa, minWidth = 6, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
resCNMOPSPKar <- calcIntegerCopyNumbers(PKar)

KPar <- referencecn.mops(cases=Kowaarenosa,controls=Piekarenosa, minWidth = 6, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
...
require(openxlsx)
write.xlsx(frequ3PKar,"CnvregionswithmeanarenosaPiekKowaarenosa_minRead6_WL350_minL6_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigPKar<-read.xlsx("CnvregionswithmeanarenosaPiekKowaarenosa_minRead6_WL350_minL6_min5samples.xlsx",1)
...
write.xlsx(frequbigPKar_lyrGenes_df,"PKar_temp_WL350.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(Thal_MapMan_frequbigPKar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_PKar_WL350.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigPKar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_PKar_WL350.xlsx",overwrite=T)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigPKar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaPiekKowaarenosacnvregions_minRead6_WL350_minL6_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="Genesarenosacnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3KPar,"CnvregionswithmeanarenosaKowaPiekarenosa_minRead6_WL350_minL6_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigKPar<-read.xlsx("CnvregionswithmeanarenosaKowaPiekarenosa_minRead6_WL350_minL6_min5samples.xlsx",1)
...
write.xlsx(frequbigKPar_lyrGenes_df,"KPar_temp_WL350.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(Thal_MapMan_frequbigKPar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_KPar_WL350.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigKPar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_KPar_WL350.xlsx",overwrite=T)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigKPar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaKowaPiekarenosacnvregions_minRead6_WL350_minL6_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="Genesarenosacnmops",col.names=TRUE,row.names=FALSE,overwrite=T)

options(java.parameters = "-Xmx12000m")
require("openxlsx")

PKar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_PKar_WL350.xlsx",1)
KPar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_KPar_WL350.xlsx",1)
...
write.table(PKaronly,"PKar_cnvs_only_strict_minL6_WL350.table",row.names=F,sep="\t")
write.table(KParonly,"KPar_cnvs_only_strict_minL6_WL350.table",row.names=F,sep="\t")
