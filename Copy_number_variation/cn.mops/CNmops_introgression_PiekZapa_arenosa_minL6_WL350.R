...
Piekarenosa <- getReadCountsFromBAM(BAMFiles=BAMFilesPiekarenosa,sampleNames=c("Piek_a10","Piek_a12","Piek_a13","Piek_a14","Piek_a15","Piek_a16","Piek_a17","Piek_a18","Piek_a19","Piek_a1","Piek_a20-1","Piek_a20-2","Piek_a22","Piek_a2","Piek_a4","Piek_a5","Piek_a7","Piek_a8","Piek_a9","Piek_h14_1","Piek_h6_2"),refSeqName=sort(scaffolds),WL=350) 
...
PZar <- referencecn.mops(cases=Piekarenosa,controls=Zapaarenosa, minWidth = 6, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
resCNMOPSPZar <- calcIntegerCopyNumbers(PZar)

ZPar <- referencecn.mops(cases=Zapaarenosa,controls=Piekarenosa, minWidth = 6, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
...
require(openxlsx)
write.xlsx(frequ3PZar,"CnvregionswithmeanarenosaPiekZapaarenosa_minRead6_WL350_minL6_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigPZar<-read.xlsx("CnvregionswithmeanarenosaPiekZapaarenosa_minRead6_WL350_minL6_min5samples.xlsx",1)
...
write.xlsx(frequbigPZar_lyrGenes_df,"PZar_temp_WL350.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(Thal_MapMan_frequbigPZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_PZar_WL350.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigPZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_PZar_WL350.xlsx",overwrite=T)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigPZar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaPiekZapaarenosacnvregions_minRead6_WL350_minL6_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3ZPar,"CnvregionswithmeanarenosaZapaPiekarenosa_minRead6_WL350_minL6_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigZPar<-read.xlsx("CnvregionswithmeanarenosaZapaPiekarenosa_minRead6_WL350_minL6_min5samples.xlsx",1)
...
write.xlsx(frequbigZPar_lyrGenes_df,"ZPar_temp_WL350.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(Thal_MapMan_frequbigZPar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZPar_WL350.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigZPar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZPar_WL350.xlsx",overwrite=T)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZPar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaZapaPiekarenosacnvregions_minRead6_WL350_minL6_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)

options(java.parameters = "-Xmx12000m")
require("openxlsx")

PZar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_PZar_WL350.xlsx",1)
ZPar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZPar_WL350.xlsx",1)
...
write.table(PZaronly,"PZar_cnvs_only_strict_minL6_WL350.table",row.names=F,sep="\t")
write.table(ZParonly,"ZPar_cnvs_only_strict_minL6_WL350.table",row.names=F,sep="\t")
