...
require(openxlsx)
write.xlsx(frequ3PZar,"CnvregionswithmeanarenosaPiekZapaarenosa_minRead6_WL500_minL2_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigPZar<-read.xlsx("CnvregionswithmeanarenosaPiekZapaarenosa_minRead6_WL500_minL2_min5samples.xlsx",1)
...
write.xlsx(frequbigPZar_lyrGenes_df,"PZar_temp.xlsx",col.names=TRUE,row.names=FALSE)
...
write.table(Thal_MapMan_frequbigPZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_PZar.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigPZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_PZar.xlsx",overwrite=T)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigPZar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaPiekZapaarenosacnvregions_minRead6_WL500_minL2_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3ZPar,"CnvregionswithmeanarenosaZapaPiekarenosa_minRead6_WL500_minL2_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigZPar<-read.xlsx("CnvregionswithmeanarenosaZapaPiekarenosa_minRead6_WL500_minL2_min5samples.xlsx",1)
...
write.xlsx(frequbigZPar_lyrGenes_df,"ZPar_temp.xlsx",col.names=TRUE,row.names=FALSE)
...
write.table(Thal_MapMan_frequbigZPar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZPar.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigZPar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZPar.xlsx",overwrite=T)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZPar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaZapaPiekarenosacnvregions_minRead6_WL500_minL2_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)

options(java.parameters = "-Xmx12000m")
require("openxlsx")

PZar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_PZar.xlsx",1)
ZPar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZPar.xlsx",1)
...
write.table(PZaronly,"PZar_cnvs_only_strict.table",row.names=F,sep="\t")
write.table(ZParonly,"ZPar_cnvs_only_strict.table",row.names=F,sep="\t")
