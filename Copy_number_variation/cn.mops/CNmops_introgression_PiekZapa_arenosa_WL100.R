...
Piekarenosa <- getReadCountsFromBAM(BAMFiles=BAMFilesPiekarenosa,sampleNames=c("Piek_a10","Piek_a12","Piek_a13","Piek_a14","Piek_a15","Piek_a16","Piek_a17","Piek_a18","Piek_a19","Piek_a1","Piek_a20-1","Piek_a20-2","Piek_a22","Piek_a2","Piek_a4","Piek_a5","Piek_a7","Piek_a8","Piek_a9","Piek_h14_1","Piek_h6_2"),refSeqName=sort(scaffolds),WL=100) 
Zapaarenosa <- getReadCountsFromBAM(BAMFiles=BAMFilesZapaarenosa,sampleNames=c("Zapa002a01","Zapa002a02","Zapa002a03","Zapa002a04","Zapa002a05","Zapa002a07","Zapa004a11","Zapa008a19","Zapa_11a03x12a01_l","Zapa_a09xa03_b"),refSeqName=sort(scaffolds),WL=100) 
...
require(openxlsx)
write.xlsx(frequ3PZar,"CnvregionswithmeanarenosaPiekZapaarenosa_minRead6_WL100_minL4_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigPZar<-read.xlsx("CnvregionswithmeanarenosaPiekZapaarenosa_minRead6_WL100_minL4_min5samples.xlsx",1)
...
write.xlsx(frequbigPZar_lyrGenes_df,"PZar_temp_WL100.xlsx",col.names=TRUE,row.names=FALSE)
...
write.table(Thal_MapMan_frequbigPZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_PZar_WL100.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigPZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_PZar_WL100.xlsx",overwrite=T)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigPZar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaPiekZapaarenosacnvregions_minRead6_WL100_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3ZPar,"CnvregionswithmeanarenosaZapaPiekarenosa_minRead6_WL100_minL4_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigZPar<-read.xlsx("CnvregionswithmeanarenosaZapaPiekarenosa_minRead6_WL100_minL4_min5samples.xlsx",1)
...
write.xlsx(frequbigZPar_lyrGenes_df,"ZPar_temp_WL100.xlsx",col.names=TRUE,row.names=FALSE)
...
write.table(Thal_MapMan_frequbigZPar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZPar_WL100.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigZPar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZPar_WL100.xlsx",overwrite=T)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZPar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaZapaPiekarenosacnvregions_minRead6_WL100_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)

options(java.parameters = "-Xmx12000m")
require("openxlsx")

PZar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_PZar_WL100.xlsx",1)
ZPar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZPar_WL100.xlsx",1)
...
write.table(PZaronly,"PZar_cnvs_only_strict_WL100.table",row.names=F,sep="\t")
write.table(ZParonly,"ZPar_cnvs_only_strict_WL100.table",row.names=F,sep="\t")
