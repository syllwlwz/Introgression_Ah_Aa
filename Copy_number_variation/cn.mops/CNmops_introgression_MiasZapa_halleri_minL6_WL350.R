...
MZha <- referencecn.mops(cases=Miashalleri,controls=Zapahalleri, minWidth = 6, minReadCount=6)
resCNMOPSMZha <- calcIntegerCopyNumbers(MZha)

ZMha <- referencecn.mops(cases=Zapahalleri,controls=Miashalleri, minWidth = 6, minReadCount=6)
...
require(openxlsx)
write.xlsx(frequ3MZha,"CnvregionswithmeanhalleriMiasZapahalleri_minRead6_WL350_minL6_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigMZha<-read.xlsx("CnvregionswithmeanhalleriMiasZapahalleri_minRead6_WL350_minL6_min5samples.xlsx",1)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigMZha_lyrGenes_df_desc_w_orthogroup_highsupport,"GeneshalleriMiasZapahallericnvregions_minRead6_WL350_minL6_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GeneshalleriWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3ZMha,"CnvregionswithmeanhalleriZapaMiashalleri_minRead6_WL350_minL6_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigZMha<-read.xlsx("CnvregionswithmeanhalleriZapaMiashalleri_minRead6_WL350_minL6_min5samples.xlsx",1)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZMha_lyrGenes_df_desc_w_orthogroup_highsupport,"GeneshalleriZapaMiashallericnvregions_minRead6_WL350_minL6_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GeneshalleriWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(MZhaonly,"MZha_cnvs_only_strict_minL6_WL350.table",row.names=F,sep="\t")
write.table(ZMhaonly,"ZMha_cnvs_only_strict_minL6_WL350.table",row.names=F,sep="\t")
