...
require(openxlsx)
write.xlsx(frequ3PZar,"CnvregionswithmeanarenosaPiekZapaarenosa_minRead6_WL350_minL4_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigPZar<-read.xlsx("CnvregionswithmeanarenosaPiekZapaarenosa_minRead6_WL350_minL4_min5samples.xlsx",1)
...
write.xlsx(frequbigPZar_lyrGenes_df,"PZar_temp_WL350.xlsx",col.names=TRUE,row.names=FALSE)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigPZar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaPiekZapaarenosacnvregions_minRead6_WL350_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3ZPar,"CnvregionswithmeanarenosaZapaPiekarenosa_minRead6_WL350_minL4_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigZPar<-read.xlsx("CnvregionswithmeanarenosaZapaPiekarenosa_minRead6_WL350_minL4_min5samples.xlsx",1)
...
write.xlsx(frequbigZPar_lyrGenes_df,"ZPar_temp_WL350.xlsx",col.names=TRUE,row.names=FALSE)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZPar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaZapaPiekarenosacnvregions_minRead6_WL350_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(PZaronly,"PZar_cnvs_only_strict_WL350.table",row.names=F,sep="\t")
write.table(ZParonly,"ZPar_cnvs_only_strict_WL350.table",row.names=F,sep="\t")
