...
BKar <- referencecn.mops(cases=Bukoarenosa,controls=Kowaarenosa, minWidth = 2, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
resCNMOPSBKar <- calcIntegerCopyNumbers(BKar)

KBar <- referencecn.mops(cases=Kowaarenosa,controls=Bukoarenosa, minWidth = 2, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
...
require(openxlsx)
write.xlsx(frequ3BKar,"CnvregionswithmeanarenosaBukoKowaarenosa_minRead6_WL500_minL2_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigBKar<-read.xlsx("CnvregionswithmeanarenosaBukoKowaarenosa_minRead6_WL500_minL2_min5samples.xlsx",1)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigBKar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaBukoKowaarenosacnvregions_minRead6_WL500_minL2_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3KBar,"CnvregionswithmeanarenosaKowaBukoarenosa_minRead6_WL500_minL2_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigKBar<-read.xlsx("CnvregionswithmeanarenosaKowaBukoarenosa_minRead6_WL500_minL2_min5samples.xlsx",1)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigKBar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaKowaBukoarenosacnvregions_minRead6_WL500_minL2_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(BKaronly,"BKar_cnvs_only_strict.table",row.names=F,sep="\t")
write.table(KBaronly,"KBar_cnvs_only_strict.table",row.names=F,sep="\t")
