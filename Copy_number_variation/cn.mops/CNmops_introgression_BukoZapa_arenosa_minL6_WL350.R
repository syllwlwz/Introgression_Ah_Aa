...
BZar <- referencecn.mops(cases=Bukoarenosa,controls=Zapaarenosa, minWidth = 6, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
resCNMOPSBZar <- calcIntegerCopyNumbers(BZar)

ZBar <- referencecn.mops(cases=Zapaarenosa,controls=Bukoarenosa, minWidth = 6, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
...
require(openxlsx)
write.xlsx(frequ3BZar,"CnvregionswithmeanarenosaBukoZapaarenosa_minRead6_WL350_minL6_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
write.xlsx(frequBZar,"CnvregionswithmeanarenosaBukoZapaarenosa_minRead6_WL350_minL6_test.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigBZar<-read.xlsx("CnvregionswithmeanarenosaBukoZapaarenosa_minRead6_WL350_minL6_min5samples.xlsx",1)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigBZar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaBukoZapaarenosacnvregions_minRead6_WL350_minL6_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3ZBar,"CnvregionswithmeanarenosaZapaBukoarenosa_minRead6_WL350_minL6_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigZBar<-read.xlsx("CnvregionswithmeanarenosaZapaBukoarenosa_minRead6_WL350_minL6_min5samples.xlsx",1)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZBar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaZapaBukoarenosacnvregions_minRead6_WL350_minL6_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(BZaronly,"BZar_cnvs_only_strict_minL6_WL350.table",row.names=F,sep="\t")
write.table(ZBaronly,"ZBar_cnvs_only_strict_minL6_WL350.table",row.names=F,sep="\t")
