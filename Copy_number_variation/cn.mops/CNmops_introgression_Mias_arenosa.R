...
MKar <- referencecn.mops(cases=Miasarenosa,controls=Kowaarenosa, minWidth = 2, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
resCNMOPSMKar <- calcIntegerCopyNumbers(MKar)

KMar <- referencecn.mops(cases=Kowaarenosa,controls=Miasarenosa, minWidth = 2, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
...
require(openxlsx)
write.xlsx(frequ3MKar,"CnvregionswithmeanarenosaMiasKowaarenosa_minRead6_WL500_minL2_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigMKar<-read.xlsx("CnvregionswithmeanarenosaMiasKowaarenosa_minRead6_WL500_minL2_min5samples.xlsx",1)
...
write.xlsx(frequbigMKar_lyrGenes_df,"MKar_temp.xlsx",col.names=TRUE,row.names=FALSE)
...
frequbigMKar_lyrGenes_df_desc_w_orthogroup_Thalgenes= merge(frequbigMKar_lyrGenes_df,Thal_description, by.x="Gene", by.y="Lyr_Gene",all.x=TRUE)
...
write.table(Thal_MapMan_frequbigMKar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_MKar.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigMKar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_MKar.xlsx",overwrite=T)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigMKar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaMiasKowaarenosacnvregions_minRead6_WL500_minL2_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3KMar,"CnvregionswithmeanarenosaKowaMiasarenosa_minRead6_WL500_minL2_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigKMar<-read.xlsx("CnvregionswithmeanarenosaKowaMiasarenosa_minRead6_WL500_minL2_min5samples.xlsx",1)
...
write.xlsx(frequbigKMar_lyrGenes_df,"KMar_temp.xlsx",col.names=TRUE,row.names=FALSE)

frequbigKMar_lyrGenes_df_desc_w_orthogroup_Thalgenes= merge(frequbigKMar_lyrGenes_df,Thal_description, by.x="Gene", by.y="Lyr_Gene",all.x=TRUE)
...
write.table(Thal_MapMan_frequbigKMar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_KMar.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigKMar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_KMar.xlsx",overwrite=T)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigKMar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaKowaMiasarenosacnvregions_minRead6_WL500_minL2_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)

options(java.parameters = "-Xmx12000m")
require("openxlsx")

MKar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_MKar.xlsx",1)
KMar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_KMar.xlsx",1)
...
write.table(MKaronly,"MKar_cnvs_only_strict.table",row.names=F,sep="\t")
write.table(KMaronly,"KMar_cnvs_only_strict.table",row.names=F,sep="\t")
