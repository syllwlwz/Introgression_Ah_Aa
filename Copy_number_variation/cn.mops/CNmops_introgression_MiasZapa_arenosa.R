...
require(openxlsx)
write.xlsx(frequ3MZar,"CnvregionswithmeanarenosaMiasZapaarenosa_minRead6_WL500_minL4_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigMZar<-read.xlsx("CnvregionswithmeanarenosaMiasZapaarenosa_minRead6_WL500_minL4_min5samples.xlsx",1)
...
write.table(Thal_MapMan_frequbigMZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_MZar.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigMZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_MZar.xlsx",overwrite=T)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigMZar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaMiasZapaarenosacnvregions_minRead6_WL500_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3ZMar,"CnvregionswithmeanarenosaZapaMiasarenosa_minRead6_WL500_minL4_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigZMar<-read.xlsx("CnvregionswithmeanarenosaZapaMiasarenosa_minRead6_WL500_minL4_min5samples.xlsx",1)
...
write.table(Thal_MapMan_frequbigZMar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZMar.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigZMar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZMar.xlsx",overwrite=T)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZMar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaZapaMiasarenosacnvregions_minRead6_WL500_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)

options(java.parameters = "-Xmx12000m")
require("openxlsx")

MZar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_MZar.xlsx",1)
ZMar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZMar.xlsx",1)
...
write.table(MZaronly,"MZar_cnvs_only_strict.table",row.names=F,sep="\t")
write.table(ZMaronly,"ZMar_cnvs_only_strict.table",row.names=F,sep="\t")
