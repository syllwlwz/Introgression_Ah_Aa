...
BZha <- referencecn.mops(cases=Bukohalleri,controls=Zapahalleri, minWidth = 6, minReadCount=6)
...
ZBha <- referencecn.mops(cases=Zapahalleri,controls=Bukohalleri, minWidth = 6, minReadCount=6)
...
require(openxlsx)
write.xlsx(frequ3BZha,"CnvregionswithmeanhalleriBukoZapahalleri_minRead6_WL350_minL6_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigBZha<-read.xlsx("CnvregionswithmeanhalleriBukoZapahalleri_minRead6_WL350_minL6_min5samples.xlsx",1)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigBZha_lyrGenes_df_desc_w_orthogroup_highsupport,"GeneshalleriBukoZapahallericnvregions_minRead6_WL350_minL6_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GeneshalleriWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3ZBha,"CnvregionswithmeanhalleriZapaBukohalleri_minRead6_WL350_minL6_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigZBha<-read.xlsx("CnvregionswithmeanhalleriZapaBukohalleri_minRead6_WL350_minL6_min5samples.xlsx",1)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZBha_lyrGenes_df_desc_w_orthogroup_highsupport,"GeneshalleriZapaBukohallericnvregions_minRead6_WL350_minL6_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GeneshalleriWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(BZhaonly,"BZha_cnvs_only_strict_minL6_WL350.table",row.names=F,sep="\t")
write.table(ZBhaonly,"ZBha_cnvs_only_strict_minL6_WL350.table",row.names=F,sep="\t")
