...
require(openxlsx)
write.xlsx(frequ3MKar,"CnvregionswithmeanarenosaMiasKowaarenosa_minRead6_WL500_minL6_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigMKar<-read.xlsx("CnvregionswithmeanarenosaMiasKowaarenosa_minRead6_WL500_minL6_min5samples.xlsx",1)
...
write.table(Thal_MapMan_frequbigMKar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_MKar_minL6_WL500.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigMKar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_MKar_minL6_WL500.xlsx",overwrite=T)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigMKar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaMiasKowaarenosacnvregions_minRead6_WL500_minL6_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3KMar,"CnvregionswithmeanarenosaKowaMiasarenosa_minRead6_WL500_minL6_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigKMar<-read.xlsx("CnvregionswithmeanarenosaKowaMiasarenosa_minRead6_WL500_minL6_min5samples.xlsx",1)
...
write.table(Thal_MapMan_frequbigKMar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_KMar_minL6_WL500.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigKMar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_KMar_minL6_WL500.xlsx",overwrite=T)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigKMar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaKowaMiasarenosacnvregions_minRead6_WL500_minL6_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)

options(java.parameters = "-Xmx12000m")
require("openxlsx")

MKar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_MKar_minL6_WL500.xlsx",1)
KMar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_KMar_minL6_WL500.xlsx",1)
...
write.table(MKaronly,"MKar_cnvs_only_strict_minL6_WL500.table",row.names=F,sep="\t")
write.table(KMaronly,"KMar_cnvs_only_strict_minL6_WL500.table",row.names=F,sep="\t")
