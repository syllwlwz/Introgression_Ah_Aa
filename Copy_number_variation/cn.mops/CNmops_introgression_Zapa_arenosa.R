...
ZKar <- referencecn.mops(cases=Zapaarenosa,controls=Kowaarenosa, minWidth = 2, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
resCNMOPSZKar <- calcIntegerCopyNumbers(ZKar)

KZar <- referencecn.mops(cases=Kowaarenosa,controls=Zapaarenosa, minWidth = 2, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
...
require(openxlsx)
write.xlsx(frequ3ZKar,"CnvregionswithmeanarenosaZapaKowaarenosa_minRead6_WL500_minL2_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigZKar<-read.xlsx("CnvregionswithmeanarenosaZapaKowaarenosa_minRead6_WL500_minL2_min5samples.xlsx",1)
...
write.xlsx(frequbigZKar_lyrGenes_df,"ZKoar_temp.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(Thal_MapMan_frequbigZKar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZKoar.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigZKar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZKoar.xlsx",overwrite=T)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigZKar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaZapaKowaarenosacnvregions_minRead6_WL500_minL2_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3KZar,"CnvregionswithmeanarenosaKowaZapaarenosa_minRead6_WL500_minL2_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigKZar<-read.xlsx("CnvregionswithmeanarenosaKowaZapaarenosa_minRead6_WL500_minL2_min5samples.xlsx",1)
...
write.xlsx(frequbigKZar_lyrGenes_df,"KoZar_temp.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(Thal_MapMan_frequbigKZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_KoZar.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigKZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_KoZar.xlsx",overwrite=T)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigKZar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaKowaZapaarenosacnvregions_minRead6_WL500_minL2_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)

options(java.parameters = "-Xmx12000m")
require("openxlsx")

ZKar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZKoar.xlsx",1)
KZar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_KoZar.xlsx",1)
...
write.table(ZKaronly,"ZKoar_cnvs_only_strict.table",row.names=F,sep="\t")
write.table(KZaronly,"KoZar_cnvs_only_strict.table",row.names=F,sep="\t")
