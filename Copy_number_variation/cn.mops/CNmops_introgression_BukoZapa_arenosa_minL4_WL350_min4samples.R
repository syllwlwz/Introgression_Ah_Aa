...
frequ4BZar<-frequBZar[count.fields(textConnection(frequBZar$sampleNames),sep=",")>=4,]
...
write.xlsx(frequ4BZar,"CnvregionswithmeanarenosaBukoZapaarenosa_minRead6_WL350_minL4_min4samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigBZar<-read.xlsx("CnvregionswithmeanarenosaBukoZapaarenosa_minRead6_WL350_minL4_min4samples.xlsx",1)
...
write.table(Thal_MapMan_frequbigBZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_BZar_min4samples.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigBZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_BZar_min4samples.xlsx",overwrite=T)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigBZar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaBukoZapaarenosacnvregions_minRead6_WL350_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast4samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.xlsx(frequ4ZBar,"CnvregionswithmeanarenosaZapaBukoarenosa_minRead6_WL350_minL4_min4samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigZBar<-read.xlsx("CnvregionswithmeanarenosaZapaBukoarenosa_minRead6_WL350_minL4_min4samples.xlsx",1)
...
write.table(Thal_MapMan_frequbigZBar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZBar_min4samples.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigZBar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZBar_min4samples.xlsx",overwrite=T)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZBar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaZapaBukoarenosacnvregions_minRead6_WL350_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast4samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)

options(java.parameters = "-Xmx12000m")
require("openxlsx")

BZar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_BZar_min4samples.xlsx",1)
ZBar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZBar_min4samples.xlsx",1)
...
write.table(BZaronly,"BZar_cnvs_only_strict_minL4_WL350_min4samples.table",row.names=F,sep="\t")
write.table(ZBaronly,"ZBar_cnvs_only_strict_minL4_WL350_min4samples.table",row.names=F,sep="\t")
