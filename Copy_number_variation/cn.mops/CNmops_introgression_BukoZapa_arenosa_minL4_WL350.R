...
write.xlsx(frequBZar,"CnvregionswithmeanarenosaBukoZapaarenosa_minRead6_WL350_minL4_test.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigBZar<-read.xlsx("CnvregionswithmeanarenosaBukoZapaarenosa_minRead6_WL350_minL4_min5samples.xlsx",1)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigBZar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaBukoZapaarenosacnvregions_minRead6_WL350_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
frequbigZBar<-read.xlsx("CnvregionswithmeanarenosaZapaBukoarenosa_minRead6_WL350_minL4_min5samples.xlsx",1)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZBar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaZapaBukoarenosacnvregions_minRead6_WL350_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(BZaronly,"BZar_cnvs_only_strict_minL4_WL350.table",row.names=F,sep="\t")
write.table(ZBaronly,"ZBar_cnvs_only_strict_minL4_WL350.table",row.names=F,sep="\t")
