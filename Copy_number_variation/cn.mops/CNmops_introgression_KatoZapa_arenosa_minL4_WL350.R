...
KZar <- referencecn.mops(cases=Katoarenosa,controls=Zapaarenosa, minWidth = 4, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
resCNMOPSKZar <- calcIntegerCopyNumbers(KZar)

ZKar <- referencecn.mops(cases=Zapaarenosa,controls=Katoarenosa, minWidth = 4, minReadCount=6,I=c(0.0125,0.025,0.5,0.75,1,1.25,1.5,1.75,2,2.25,2.5,2.75,3,4),classes=c("CN0","CN1","CN2","CN3","CN4","CN5","CN6","CN7","CN8","CN9","CN10","CN11","CN12","CN16"))
...
require(openxlsx)
write.xlsx(frequ3KZar,"CnvregionswithmeanarenosaKatoZapaarenosa_minRead6_WL350_minL4_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigKZar<-read.xlsx("CnvregionswithmeanarenosaKatoZapaarenosa_minRead6_WL350_minL4_min5samples.xlsx",1)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigKZar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaKatoZapaarenosacnvregions_minRead6_WL350_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3ZKar,"CnvregionswithmeanarenosaZapaKatoarenosa_minRead6_WL350_minL4_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigZKar<-read.xlsx("CnvregionswithmeanarenosaZapaKatoarenosa_minRead6_WL350_minL4_min5samples.xlsx",1)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZKar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaZapaKatoarenosacnvregions_minRead6_WL350_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
write.table(KZaronly,"KaZar_cnvs_only_strict_minL4_WL350.table",row.names=F,sep="\t")
write.table(ZKaronly,"ZKaar_cnvs_only_strict_minL4_WL350.table",row.names=F,sep="\t")
