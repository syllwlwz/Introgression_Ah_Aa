...
Miasarenosa <- getReadCountsFromBAM(BAMFiles=BAMFilesMiasarenosa,sampleNames=c("Mias001a18","Mias003a09","Mias003a10","Mias003a11","Mias003a13","Mias003a15","Mias003a16","Mias_19a03x21a01_d","Mias_23a03x22a03_k","Mias_a12xa05_l","Mias_a42","Mias_a43","Mias_a44","Mias_a45","Mias_a46","Mias_a47","Mias_a48","Mias_a50","Mias_a55"),refSeqName=sort(scaffolds),WL=400) 
Zapaarenosa <- getReadCountsFromBAM(BAMFiles=BAMFilesZapaarenosa,sampleNames=c("Zapa002a01","Zapa002a02","Zapa002a03","Zapa002a04","Zapa002a05","Zapa002a07","Zapa004a11","Zapa008a19","Zapa_11a03x12a01_l","Zapa_a09xa03_b"),refSeqName=sort(scaffolds),WL=400) 
...
require(openxlsx)
write.xlsx(frequ3MZar,"CnvregionswithmeanarenosaMiasZapaarenosa_minRead6_WL400_minL4_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)

frequbigMZar<-read.xlsx("CnvregionswithmeanarenosaMiasZapaarenosa_minRead6_WL400_minL4_min5samples.xlsx",1)
...
write.table(Thal_MapMan_frequbigMZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_MZar_minL4_WL400.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigMZar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_MZar_minL4_WL400.xlsx",overwrite=T)
...
#119 unique genes
write.xlsx(Thal_MapMan_frequbigMZar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaMiasZapaarenosacnvregions_minRead6_WL400_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)
...
require(openxlsx)
write.xlsx(frequ3ZMar,"CnvregionswithmeanarenosaZapaMiasarenosa_minRead6_WL400_minL4_min5samples.xlsx",col.names=TRUE,row.names=FALSE,overwrite=T)
frequbigZMar<-read.xlsx("CnvregionswithmeanarenosaZapaMiasarenosa_minRead6_WL400_minL4_min5samples.xlsx",1)
...
write.table(Thal_MapMan_frequbigZMar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZMar_minL4_WL400.txt", sep="\t", row.names=F)
write.xlsx(Thal_MapMan_frequbigZMar_lyrGenes_df_desc_w_orthogroup,"GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZMar_minL4_WL400.xlsx",overwrite=T)
...
#133 unique genes
write.xlsx(Thal_MapMan_frequbigZMar_lyrGenes_df_desc_w_orthogroup_highsupport,"GenesarenosaZapaMiasarenosacnvregions_minRead6_WL400_minL4_minoverlap90percentofgene_atleast90percentsupport_atleast5samples.xlsx",sheetName="GenesarenosaWulmoutgroupcnmops",col.names=TRUE,row.names=FALSE,overwrite=T)

options(java.parameters = "-Xmx12000m")
require("openxlsx")

MZar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_MZar_minL4_WL400.xlsx",1)
ZMar<-read.xlsx("GenesOverlappingSignificantMarkers_ThalianaOrthologs_MapManDescriptions_MetalOverlaps_ZMar_minL4_WL400.xlsx",1)
...
write.table(MZaronly,"MZar_cnvs_only_strict_minL4_WL400.table",row.names=F,sep="\t")
write.table(ZMaronly,"ZMar_cnvs_only_strict_minL4_WL400.table",row.names=F,sep="\t")
