...
java -Xmx80g -Xms80g -XX:ConcGCThreads=4 -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar GenomicsDBImport -R /prj/pflaphy-gscan/Alyrata_107.fa\
 -V /prj/pflaphy-gscan/HC1_introgression/A_pe_1.full.g.vcf.gz -V /prj/pflaphy-gscan/HC1_introgression/A_pe_2.full.g.vcf.gz\
 --use-jdk-inflater --tmp-dir /prj/pflaphy-gscan/HC2_temp/ -DF NotDuplicateReadFilter -L $Scaffold --genomicsdb-workspace-path /prj/pflaphy-gscan/DB_introgression_pedemontana_$Scaffold/ --batch-size 50 --max-num-intervals-to-import-in-parallel 4 --merge-input-intervals true --genomicsdb-shared-posixfs-optimizations true 2> /prj/pflaphy-gscan/HC2_introgression/GenomicsDBimport_pedemontana_$Scaffold.err
