...
java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -V /prj/pflaphy-gscan/Filtered_introgression2/Introgression_halleri_renamed_sorted_unphased_fil3_higherDP.vcf -R Alyrata_107.fa --exclude-filtered -sn Kato_h09 -O Filtered_introgression2/Kato_halleri_renamed_sorted_unphased_fil4_higherDP.vcf 2> Filtered_introgression2/Kato_halleri_renamed_sorted_unphased_fil4.err

#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=16" -V Filtered_introgression2/Buko_halleri_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Buko_halleri_renamed_sorted_unphased_fil5_higherDP.vcf\
# 2> Filtered_introgression2/Buko_halleri_renamed_sorted_unphased_fil5.err
#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=16" -V Filtered_introgression2/Mias_halleri_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Mias_halleri_renamed_sorted_unphased_fil5_higherDP.vcf\
# 2> Filtered_introgression2/Mias_halleri_renamed_sorted_unphased_fil5.err
#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=16" -V Filtered_introgression2/Piek_halleri_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Piek_halleri_renamed_sorted_unphased_fil5_higherDP.vcf\
# 2> Filtered_introgression2/Piek_halleri_renamed_sorted_unphased_fil5.err
#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=16" -V Filtered_introgression2/Zapa_halleri_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Zapa_halleri_renamed_sorted_unphased_fil5_higherDP.vcf\
# 2> Filtered_introgression2/Zapa_halleri_renamed_sorted_unphased_fil5.err

#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -V /prj/pflaphy-gscan/Filtered_introgression2/Introgression_halleri_renamed_sorted_unphased_fil3_higherDP.vcf -R Alyrata_107.fa --exclude-filtered -sn Introgression_filter_list_Kowa_halleri.args -O Filtered_introgression2/Kowa_halleri_renamed_sorted_unphased_fil4_higherDP.vcf 2> Filtered_introgression2/Kowa_halleri_renamed_sorted_unphased_fil4_higherDP.err
...
# 2> Filtered_introgression2/Kowa_halleri_renamed_sorted_unphased_fil5_higherDP.err
