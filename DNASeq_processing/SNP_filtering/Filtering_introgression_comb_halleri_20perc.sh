...
java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=(0.8*$Buko_n*2)" -V Filtered_introgression2/Buko_halleri_renamed_sorted_unphased_fil4.vcf -O Filtered_introgression2/Buko_halleri_renamed_sorted_unphased_fil5_20perc.vcf\
 2> Filtered_introgression2/Buko_halleri_renamed_sorted_unphased_fil5_20perc.err
java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=(0.8*$Mias_n*2)" -V Filtered_introgression2/Mias_halleri_renamed_sorted_unphased_fil4.vcf -O Filtered_introgression2/Mias_halleri_renamed_sorted_unphased_fil5_20perc.vcf\
 2> Filtered_introgression2/Mias_halleri_renamed_sorted_unphased_fil5_20perc.err
java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=(0.8*$Piek_n*2)" -V Filtered_introgression2/Piek_halleri_renamed_sorted_unphased_fil4.vcf -O Filtered_introgression2/Piek_halleri_renamed_sorted_unphased_fil5_20perc.vcf\
 2> Filtered_introgression2/Piek_halleri_renamed_sorted_unphased_fil5_20perc.err
java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=(0.8*$Zapa_n*2)" -V Filtered_introgression2/Zapa_halleri_renamed_sorted_unphased_fil4.vcf -O Filtered_introgression2/Zapa_halleri_renamed_sorted_unphased_fil5_20perc.vcf\
 2> Filtered_introgression2/Zapa_halleri_renamed_sorted_unphased_fil5_20perc.err
