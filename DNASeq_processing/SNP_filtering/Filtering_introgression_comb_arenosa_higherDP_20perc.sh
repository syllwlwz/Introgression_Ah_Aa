...
Buko_n=$(wc -l Introgression_filter_list_Buko_arenosa.args | cut -f 1 -d " ")
Kato_n=$(wc -l Introgression_filter_list_Kato_arenosa.args | cut -f 1 -d " ")
#Mias_n=$(wc -l Introgression_filter_list_Mias_arenosa.args | cut -f 1 -d " ")
#Piek_n=$(wc -l Introgression_filter_list_Piek_arenosa.args | cut -f 1 -d " ")
#Zapa_n=$(wc -l Introgression_filter_list_Zapa_arenosa.args | cut -f 1 -d " ")
#Kowa_n=$(wc -l Introgression_filter_list_Kowa_arenosa.args | cut -f 1 -d " ")

java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=(0.8*$Buko_n*4)" -V Filtered_introgression2/Buko_arenosa_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Buko_arenosa_renamed_sorted_unphased_fil5_higherDP_20perc.vcf\
 2> Filtered_introgression2/Buko_arenosa_renamed_sorted_unphased_fil5_higherDP_20perc.err
java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>(0.8*$Kato_n*4)" -V Filtered_introgression2/Kato_arenosa_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Kato_arenosa_renamed_sorted_unphased_fil5_higherDP_20perc.vcf\
 2> Filtered_introgression2/Kato_arenosa_renamed_sorted_unphased_fil5_higherDP_20perc.err
#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=(0.8*$Mias_n*4)" -V Filtered_introgression2/Mias_arenosa_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Mias_arenosa_renamed_sorted_unphased_fil5_higherDP_20perc.vcf\
# 2> Filtered_introgression2/Mias_arenosa_renamed_sorted_unphased_fil5_higherDP_20perc.err
#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=(0.8*$Piek_n*4)" -V Filtered_introgression2/Piek_arenosa_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Piek_arenosa_renamed_sorted_unphased_fil5_higherDP_20perc.vcf\
# 2> Filtered_introgression2/Piek_arenosa_renamed_sorted_unphased_fil5_higherDP_20perc.err
#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=(0.8*$Zapa_n*4)" -V Filtered_introgression2/Zapa_arenosa_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Zapa_arenosa_renamed_sorted_unphased_fil5_higherDP_20perc.vcf\
# 2> Filtered_introgression2/Zapa_arenosa_renamed_sorted_unphased_fil5_higherDP_20perc.err
#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=(0.8*$Kowa_n*4)" -V Filtered_introgression2/Kowa_arenosa_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Kowa_arenosa_renamed_sorted_unphased_fil5_higherDP_20perc.vcf\
# 2> Filtered_introgression2/Kowa_arenosa_renamed_sorted_unphased_fil5_higherDP_20perc.err
