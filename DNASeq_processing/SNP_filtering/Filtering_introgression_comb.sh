...
grep -v "DP" /prj/pflaphy-gscan/Filtered_introgression2/Introgression_halleri_renamed_sorted_unphased_fil2.table | grep -v "NA" > /prj/pflaphy-gscan/Filtered_introgression2/Introgression_halleri_renamed_sorted_unphased_fil2_DP.table
mode=$(./software/R-4.1.0/bin/Rscript -e 'library("LaplacesDemon"); data<-read.table("/prj/pflaphy-gscan/Filtered_introgression2/Introgression_halleri_renamed_sorted_unphased_fil2_DP.table",header=F); cat(Mode(data$V1)[1])')
DPmax=2*$mode
DPmin=0.5*$mode
...
java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -V /prj/pflaphy-gscan/Filtered_introgression2/Introgression_halleri_renamed_sorted_unphased_fil3.vcf -R Alyrata_107.fa --exclude-filtered\
 -sn Introgression_filter_list_Buko_halleri.args -O Filtered_introgression2/Buko_halleri_renamed_sorted_unphased_fil4.vcf 2> Filtered_introgression2/Buko_halleri_renamed_sorted_unphased_fil4.err
java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -V /prj/pflaphy-gscan/Filtered_introgression2/Introgression_halleri_renamed_sorted_unphased_fil3.vcf -R Alyrata_107.fa --exclude-filtered\ 
 -sn Introgression_filter_list_Mias_halleri.args -O Filtered_introgression2/Mias_halleri_renamed_sorted_unphased_fil4.vcf 2> Filtered_introgression2/Mias_halleri_renamed_sorted_unphased_fil4.err
java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -V /prj/pflaphy-gscan/Filtered_introgression2/Introgression_halleri_renamed_sorted_unphased_fil3.vcf -R Alyrata_107.fa --exclude-filtered\ 
 -sn Introgression_filter_list_Piek_halleri.args -O Filtered_introgression2/Piek_halleri_renamed_sorted_unphased_fil4.vcf 2> Filtered_introgression2/Piek_halleri_renamed_sorted_unphased_fil4.err
java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -V /prj/pflaphy-gscan/Filtered_introgression2/Introgression_halleri_renamed_sorted_unphased_fil3.vcf -R Alyrata_107.fa --exclude-filtered\ 
 -sn Introgression_filter_list_Zapa_halleri.args -O Filtered_introgression2/Zapa_halleri_renamed_sorted_unphased_fil4.vcf 2> Filtered_introgression2/Zapa_halleri_renamed_sorted_unphased_fil4.err

./software/bcftools-1.12/bcftools view -i '(N_SAMPLES-N_MISSING)>7' Filtered_introgression2/Buko_halleri_renamed_sorted_unphased_fil4.vcf > Filtered_introgression2/Buko_halleri_renamed_sorted_unphased_fil5.vcf\
 2> Filtered_introgression2/Buko_halleri_renamed_sorted_unphased_fil5.err
./software/bcftools-1.12/bcftools view -i '(N_SAMPLES-N_MISSING)>7' Filtered_introgression2/Mias_halleri_renamed_sorted_unphased_fil4.vcf > Filtered_introgression2/Mias_halleri_renamed_sorted_unphased_fil5.vcf\ 
 2> Filtered_introgression2/Mias_halleri_renamed_sorted_unphased_fil5.err
./software/bcftools-1.12/bcftools view -i '(N_SAMPLES-N_MISSING)>7' Filtered_introgression2/Piek_halleri_renamed_sorted_unphased_fil4.vcf > Filtered_introgression2/Piek_halleri_renamed_sorted_unphased_fil5.vcf\ 
 2> Filtered_introgression2/Piek_halleri_renamed_sorted_unphased_fil5.err
./software/bcftools-1.12/bcftools view -i '(N_SAMPLES-N_MISSING)>7' Filtered_introgression2/Zapa_halleri_renamed_sorted_unphased_fil4.vcf > Filtered_introgression2/Zapa_halleri_renamed_sorted_unphased_fil5.vcf\ 
