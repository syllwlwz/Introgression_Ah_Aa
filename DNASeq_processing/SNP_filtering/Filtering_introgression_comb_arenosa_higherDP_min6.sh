...
java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=24" -V Filtered_introgression2/Buko_arenosa_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Buko_arenosa_renamed_sorted_unphased_fil5_higherDP_min6.vcf\
 2> Filtered_introgression2/Buko_arenosa_renamed_sorted_unphased_fil5_higherDP_min6.err
java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=24" -V Filtered_introgression2/Kato_arenosa_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Kato_arenosa_renamed_sorted_unphased_fil5_higherDP_min6.vcf\
 2> Filtered_introgression2/Kato_arenosa_renamed_sorted_unphased_fil5_higherDP_min6.err
#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=24" -V Filtered_introgression2/Mias_arenosa_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Mias_arenosa_renamed_sorted_unphased_fil5_higherDP_min6.vcf\
# 2> Filtered_introgression2/Mias_arenosa_renamed_sorted_unphased_fil5_higherDP_min6.err
#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=24" -V Filtered_introgression2/Piek_arenosa_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Piek_arenosa_renamed_sorted_unphased_fil5_higherDP_min6.vcf\
# 2> Filtered_introgression2/Piek_arenosa_renamed_sorted_unphased_fil5_higherDP_min6.err
#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=24" -V Filtered_introgression2/Zapa_arenosa_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Zapa_arenosa_renamed_sorted_unphased_fil5_higherDP_min6.vcf\
# 2> Filtered_introgression2/Zapa_arenosa_renamed_sorted_unphased_fil5_higherDP_min6.err
#java -Xmx50g -jar software/gatk-4.1.9.0/gatk-package-4.1.9.0-local.jar SelectVariants -select "AN>=24" -V Filtered_introgression2/Kowa_arenosa_renamed_sorted_unphased_fil4_higherDP.vcf -O Filtered_introgression2/Kowa_arenosa_renamed_sorted_unphased_fil5_higherDP_min6.vcf\
# 2> Filtered_introgression2/Kowa_arenosa_renamed_sorted_unphased_fil5_higherDP_min6.err
