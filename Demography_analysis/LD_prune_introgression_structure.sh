...
python2 /prj/pflaphy-gscan/software/LD_prune.py -v /prj/pflaphy-gscan/Structure/ -w 500 -r 1 -d 1000 -o LD_struc -gz false -s true -c 0.1 -m 1 -mf 0 -s true 2> LDprune_structure.err
