...
vcf<-read.vcfR("MiasKowaarenosa_scaffold2.vcf", verbose = FALSE)
...
Fst_df4$Scaffold<-"Scaffold_2"
write.table(Fst_df4,"Fst_Mias_Kowa_arenosa_scaffold2_25SNPwins.table",sep="\t",row.names=F,quote=F)
