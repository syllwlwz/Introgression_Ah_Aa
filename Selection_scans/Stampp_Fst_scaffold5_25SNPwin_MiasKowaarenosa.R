...
vcf<-read.vcfR("MiasKowaarenosa_scaffold5.vcf", verbose = FALSE)
...
Fst_df4$Scaffold<-"Scaffold_5"
write.table(Fst_df4,"Fst_Mias_Kowa_arenosa_scaffold5_25SNPwins.table",sep="\t",row.names=F,quote=F)
