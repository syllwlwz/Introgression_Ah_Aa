...
vcf<-read.vcfR("MiasKowaarenosa_scaffold8.vcf", verbose = FALSE)
...
Fst_df4$Scaffold<-"Scaffold_8"
write.table(Fst_df4,"Fst_Mias_Kowa_arenosa_scaffold8_25SNPwins.table",sep="\t",row.names=F,quote=F)
