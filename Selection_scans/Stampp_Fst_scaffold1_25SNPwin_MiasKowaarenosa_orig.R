...
vcf<-read.vcfR("MiasKowaarenosa_scaffold1.vcf", verbose = FALSE)

##2.2 Convert vcf into genlight object
Intro_GL <- vcfR2genlight(vcf)
...
Fst_df4$Scaffold<-"Scaffold_1"
write.table(Fst_df4,"Fst_Mias_Kowa_arenosa_scaffold1_25SNPwins_orig.table",sep="\t",row.names=F,quote=F)
