...
vcf<-read.vcfR("MiasKowaarenosa_scaffold9.vcf", verbose = FALSE)
...
Fst_df4$Scaffold<-"Scaffold_9"
write.table(Fst_df4,"Fst_Mias_Kowa_arenosa_scaffold9_25SNPwins.table",sep="\t",row.names=F,quote=F)
