...
vcf<-read.vcfR("MiasKowaarenosa_scaffold4.vcf", verbose = FALSE)
...
Fst_df4$Scaffold<-"Scaffold_4"
write.table(Fst_df4,"Fst_Mias_Kowa_arenosa_scaffold4_25SNPwins.table",sep="\t",row.names=F,quote=F)
