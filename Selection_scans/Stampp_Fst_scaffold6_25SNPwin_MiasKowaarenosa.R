...
vcf<-read.vcfR("MiasKowaarenosa_scaffold6.vcf", verbose = FALSE)
...
Fst_df4$Scaffold<-"Scaffold_6"
write.table(Fst_df4,"Fst_Mias_Kowa_arenosa_scaffold6_25SNPwins.table",sep="\t",row.names=F,quote=F)
