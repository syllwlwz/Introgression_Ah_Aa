...
vcf<-read.vcfR("MiasKowaarenosa_scaffold3.vcf", verbose = FALSE)
...
Fst_df4$Scaffold<-"Scaffold_3"
write.table(Fst_df4,"Fst_Mias_Kowa_arenosa_scaffold3_25SNPwins.table",sep="\t",row.names=F,quote=F)
